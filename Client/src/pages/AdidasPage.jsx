...
import adidasVideo from "../assets/adidas-video.mp4";
...
const AdidasPage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[93vh] w-full flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-6">
          ...
          >
            ...
            <span className="font-semibold">Adidas Shoes</span>. From running to
      ...
      {/* Product Section  */}
      <div className="mt-6">
        <ProductGrid brand="Adidas" title="Adidas Best Sellers" />
      </div>
      <Footer />
    </div>
  );
