...
import nikeVideo from "../assets/nike-video.mp4";
...
const NikePage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[93vh] w-full flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-6">
          ...
          >
            ...
            <span className="font-semibold">Nike Shoes</span>. From running to
      ...
      {/* Nike Product Section  */}
      <div className="mt-6">
        <ProductGrid brand="Nike" title="Nike Best Sellers" />
      </div>
