...
import converseVideo from "../assets/converse-video.webm";
...
const ConversePage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[93vh] w-full flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-6">
          ...
          >
            ...
            <span className="font-semibold">Converse Shoes</span>. From running to
      ...
      {/* Product Section  */}
      <div className="mt-6">
        <ProductGrid brand="Converse" title="Converse Best Sellers" />
      </div>
